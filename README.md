![xperiun_SQLite](xperiun_SQLite.jpg)

# Minicurso de SQLite



Este minicurso de 1 hora foi desenvolvido para quem deseja sair do zero e conquistar uma base sólida em SQL, a linguagem essencial para análise e manipulação de dados. Em um formato direto e prático, você aprenderá os fundamentos necessários para começar a construir consultas eficientes e resolver problemas do mundo real.
